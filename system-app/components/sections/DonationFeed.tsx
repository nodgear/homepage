  ...
  return <section className='flex flex-row justify-center w-full h-screen px-20 py-32'>
    <div className='flex flex-col items-center justify-center w-2/3 h-full'>
      <div className="flex flex-col items-center justify-center w-full py-3">
        <h1 className='mb-6 text-lg text-3xl font-bold text-accent'>Número de doadores:<span className='ml-2 text-white'>69</span></h1>
        <h1 className='text-lg text-3xl font-bold text-accent'>Valor arrecadado:<span className='ml-2 text-white'>69</span></h1>
